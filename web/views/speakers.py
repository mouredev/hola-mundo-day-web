...
def _speaker(title: str, body: str, author: str, url: str, avatar: str, video: str) -> rx.Component:
    return rx.flex(
        rx.image(
            src=avatar,
            width="180px",
